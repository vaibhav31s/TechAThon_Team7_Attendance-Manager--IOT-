    ...
    <div className="justify-center items-center ">
      <div className="flex flex-col items-center ">
        ...
        <p className="text-gray-700 dark:text-gray-300">
          <span className="text-gray-400 dark:text-gray-50 ">Joined:</span>{" "}
        </p>
          ...
          <div className="flex-1 bg-white dark:bg-black rounded-lg shadow-xl p-8">
            ...
            <ul className="mt-2 text-gray-700">
              ...
              <li className="flex border-b py-2 justify-between">
                ...
                <span className="text-gray-400">Total of Rs. 121 Spent</span>
                <span className="text-gray-400 "></span>
              </li>
              <li className="flex border-b py-2 justify-between">
                <span className="font-bold w-24 dark:text-gray-300">
              ...
              <li className="flex border-b py-2 justify-between">
                ...
                <span className="text-gray-400 ">Belongs to Cluster No :</span>
                <span className="text-gray-400 "></span>
              </li>
              <li className="flex border-b py-2 justify-between">
                <span className="font-bold w-24 dark:text-gray-300 ">
                ...
                <span className="text-gray-400">Deals Made in Total</span>
                <span className="text-gray-400 "></span>
              </li>
              <li className="flex border-b py-2 justify-between">
                <span className="font-bold w-24 dark:text-gray-300">
