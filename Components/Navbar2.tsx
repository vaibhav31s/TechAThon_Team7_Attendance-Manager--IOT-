        ...
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="flex gap-2">
            ...
            {data?.user ? (
              ...
              <>
                <Link href="/login"  className="inline-flex items-center justify-center px-3 py-1.5 mr-3 text-base font-medium text-center dark:text-white  rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                  Login
                </Link>
              ...
              {/* {data?.user ?  (
                <MenuDropdown session={data?.user} />
              ) : (
                <button
